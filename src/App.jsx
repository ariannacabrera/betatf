...
/* ====================================================================
   ADMIN COMPONENTS (Moved outside)
   ==================================================================== */
...
// This component is self-contained and fetches its own data.
// Moving it outside prevents the inputs from losing focus.
...
const AdminDashboard = ({ handleLogout, orders, products, setProducts }) => {
...
    setProducts(refreshed || []); // Pass state up to TanyFoodsApp
...
            className={`flex-1 py-3 rounded-lg font-medium flex items-center justify-center gap-2 ${activeTab === 'orders' ? 'bg-teal-600 text-white' : 'bg-white text-gray-700'
              }`}>
            <Package size={20} /> Orders
          </button>
          <button
            onClick={() => setActiveTab('products')}
            className={`flex-1 py-3 rounded-lg font-medium flex items-center justify-center gap-2 ${activeTab === 'products' ? 'bg-teal-600 text-white' : 'bg-white text-gray-700'
              }`}>
            <Upload size={20} /> Products
          </button>
          <button
            onClick={() => setActiveTab('customers')}
            className={`flex-1 py-3 rounded-lg font-medium flex items-center justify-center gap-2 ${activeTab === 'customers' ? 'bg-teal-600 text-white' : 'bg-white text-gray-700'
              }`}>
            Customers
          </button>
        </div>
...
  /* ------------- Main Render ------------- */
  // All component definitions have been moved above TanyFoodsApp.
  // Now we just render the correct one and pass props.
